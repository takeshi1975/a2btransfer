...
public class ReserveRs {
	 ...
	 * 
	 * @return possible object is {@link ReserveRs.TransferOnly }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link ReserveRs.TransferOnly }
	 * 
	 */
	...
	public static class TransferOnly {
		 ...
		 * 
		 * @return possible object is {@link ReserveRs.TransferOnly.Booking }
		 * 
		 */
		 ...
		 * 
		 * @param value
		 *            allowed object is {@link ReserveRs.TransferOnly.Booking }
		 * 
		 */
		 ...
		 */
		@XmlAccessorType(XmlAccessType.FIELD)
		@XmlType(name = "", propOrder = { "reserve" })
		public static class Booking {
			 ...
			 */
			@XmlAccessorType(XmlAccessType.FIELD)
			@XmlType(name = "", propOrder = { "transacNo", "holidayValue", "currencyCode" })
